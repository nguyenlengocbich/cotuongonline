        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {isRegister && (
            <div className="space-y-1 animate-slide-down">
              <label className="text-[10px] font-black text-slate-500 uppercase ml-1 tracking-tighter">Tên hiển thị (Tùy chọn)</label>
              <div className="relative">
          ...
          >
            {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : (isRegister ? 'Đăng Ký' : 'Vào Kỳ Đài')}
          </button>
        </form>
